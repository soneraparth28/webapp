...
class BuilderController extends Controller
{
  public function index()
  {
    ...
    return view('webbuilder.builder');
  }
  ...
  public function larabuilder()
  {
    ...
    return view('webbuilder.larabuilder');
  }
  ...
  public function lara(Request $request)
  {
    ...
    if (empty($project))
      return view('webbuilder.lara', $data);
    else {
      return $this->editLara($project);
    }
  }

  private function editLara($project)
  {
    $projectfile = \App\Models\ProjectFile::where('related_to', 'projects')->where('related_id', $project->id)->first();
    ...
    return view('webbuilder.editlara', $data);
  }
  ...
  public function ajax(Request $request)
  {
    ...
    define('CURRENT_COMPANY', Auth::getUser()->username);
