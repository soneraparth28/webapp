...
//            $returnObject = ["updatesCompleted" => $updatesCompleted, "updatesStarted" => $updatesStarted, "userId" => $userId ];
    ...
    public function mediaViewAjaxCreateForEmbed(Request $request) {
        if(!$this->mediaViewRowItemExists($request->update_id, $request->media_id)) $this->createMediaViewItem($request->update_id, $request->media_id, $request->duration ?? 0);
    ...
    private function createMediaViewItem($updateId, $mediaId, $duration = 0) {
