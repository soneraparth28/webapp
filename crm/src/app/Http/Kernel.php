...
//            \App\Http\Middleware\XssProtectionMiddleware::class,
    ...
    protected $routeMiddleware = [
        ...
        'brand' => \App\Http\Middleware\AuthorizeBrandMiddleware::class,
        'app.role' => \App\Http\Middleware\CheckAppRoleMiddleWare::class,
        'app.installed' => \App\Http\Middleware\CheckIfInstalledMiddleware::class,
        'app.not-installed' => \App\Http\Middleware\CheckIfNotInstalled::class,
