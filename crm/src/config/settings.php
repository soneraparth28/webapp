...
return [
    ...
    'app' => [
        ['name' => 'company_name', 'value' => env('APP_NAME', 'Mailer - Email Marketing Application'), 'context' => 'app', 'autoload' => 0, 'public' => 1],
    ...
    'brand_default_prefix' => [
        ...
        'smtp' => 'brand_default_smtp',
        'privacy' => 'brand_default_privacy',
        'notification' => 'brand_default_notification',
    ],
    'smtp-tracker-thumbnail' => 'images/smtp-tracker.gif'
