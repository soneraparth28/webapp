...
<p><a href="{resource_url}" style="background: #4466F2;color: white;padding: 9px;border-radius: 4px;cursor: pointer; ; text-decoration: none; text-underline: none; box-shadow: 0 4px 4px rgba(0, 0, 0, 0.2)" target="_blank">{button_label}</a></p><br>
<p></p><p>Thanks for being with us.
</p><p>Regards,</p><p>{app_name}</p><p></p><p></p>'
            ],
            'updated' => [
...
<p></p><p>Thanks for being with us.
            ...
            'deleted' => [
                ...
                'content' => '<p><img src="{app_logo}" style="height: 75px"></p>
<p>
</p><p><span style="background-color: var(--form-control-bg) ; color: var(--default-font-color) ;">Hi {receiver_name}</span><br></p><p>We are going to inform you that a brand named {brand_name} has been deleted from our application by {action_by}.</p>
<p></p><p>Thanks for being with us.
</p><p>Regards,</p><p>{app_name}</p><p></p><p></p>'
            ],
            'confirmed' => [
...
<p></p><p>Thanks for being with us.
            ...
            'archived' => [
                'system' => 'A {resource} named {name} has been archived by {action_by}.',
                'subject' => 'A {resource} has been archived in {app_name}',
                'content' => '<p><img src="{app_logo}" style="height: 75px"></p>
<p>
...
<p></p><p>Thanks for being with us.
            ...
            'activated' => [
                ...
                'subject' => 'A {resource} has been activated in {app_name}',
                'content' => '<p><img src="{app_logo}" style="height: 75px"></p>
<p>
...
<p></p><p>Thanks for being with us.
            ...
            'deactivated' => [
                ...
                'subject' => 'A {resource} has been deactivated in {app_name}',
                'content' => '<p><img src="{app_logo}" style="height: 75px"></p>
<p>
