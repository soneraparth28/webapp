...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ auth()->check() && User::notificationsCount() ? '('.User::notificationsCount().') ' : '' }}Mator</title>
        <!-- Favicon -->
            ...
            <div class="container">
                ...
                <div class="row justify-content-center mb-sm">
                    <div class="col-md-6 col-lg-9 mb-5 mb-lg-0">
                        ...
                        <form method="POST" action="{{ url('api/add/funds') }}" id="formAddFunds">
                            @csrf
                            <div class="form-group mb-4">
                                ...
                                <p class="help-block margin-bottom-zero fee-wrap">
                                    <span class="d-block w-100">
                                        {{ trans('general.transaction_fee') }}:<span class="float-right"><strong>{{ $settings->currency_position == 'left' ? $settings->currency_symbol : null }}<span id="handlingFee">0</span>{{ $settings->currency_position == 'right' ? $settings->currency_symbol : null }}</strong></span>
