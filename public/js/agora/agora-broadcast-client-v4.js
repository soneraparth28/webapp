...
var options = {
  ...
  // token:'00648b1cac97deb40b2a007932a9e8e7801IADW6LMBlhYhZLwMY5iJcAnlqtam11DFvd+9VK2ao+8nNQbvC1S379yDIgDjIwAAQMlTZAQAAQDQhVJkAwDQhVJkAgDQhVJkBADQhVJk',
  token: agoraToken,
...
async function joinChannel() {
  if (options.role === "audience") {
      ...
      client.on("user-published", abcdefg);
...
async function subscribe(user, mediaType) {
    ...
    if (mediaType === 'audio') {
      ...
      $('#liveAudio').click(function(event) {
          consolelog(user.audioTrack.isPlaying)
