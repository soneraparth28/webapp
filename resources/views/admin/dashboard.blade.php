...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content">
        	...
        	<div class="row dash_stat">

        <div class="col-lg-3">
              <!-- small box -->
              <div class="small-box dash_field">
                <div class="inner">
                ...
                <div class="icon">
                  <i class="iconmoon icon-Dollar"></i>
								...
								<a href="{{url('panel/admin/subscriptions')}}" class="small-box-footer dash_field">{{trans('general.view_more')}} <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
               <div class="col-lg-3">
              <!-- small box -->
              <div class="small-box dash_field">
                ...
                <div class="icon">
                  <i class="iconmoon icon-Users"></i>
								...
								<a href="{{url('panel/admin/members')}}" class="small-box-footer dash_field">{{trans('general.view_more')}} <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
              <div class="col-lg-3">
              <!-- small box -->
              ...
              <div class="small-box dash_field">
                ...
                <div class="icon">
                  <i class="fa fa-user-edit"></i>
								...
								<a href="{{url('panel/admin/posts')}}" class="small-box-footer dash_field">{{trans('general.view_more')}} <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
              ...
              <div class="small-box dash_field">
                <div class="inner">
                  <h3>{{ Helper::amountFormatDecimal($sales) }}</h3>
                  <p>{{ trans('Revenue') }}</p>
                </div>
                <div class="icon">
                  <i class="iconmoon icon-Dollar"></i>
                </div>
                	<span class="small-box-footer dash_field">{{trans('Revenue')}}</span>
            ...
            <div class="col-lg-3">
              ...
              <div class="small-box dash_field">
                <div class="inner">
                  <h3>{{ Helper::amountFormatDecimal($creator_earning) }}</h3>
                  <p>{{ trans('Creator Earnings') }}</p>
                </div>
                <div class="icon">
                  <i class="iconmoon icon-Bag"></i>
                </div>
								<span class="small-box-footer dash_field">{{trans('Creator Earning')}}</span>
              </div>
            </div><!-- ./col -->
            ...
            <div class="col-lg-3">
              ...
              <div class="small-box dash_field">
                <div class="inner">
                  <h3>{{ Helper::amountFormatDecimal($referralTransaction) }}</h3>
                  <p>{{ trans('Partner Earnings') }}</p>
                </div>
                <div class="icon">
                  <i class="iconmoon icon-Bag"></i>
                </div>
                	<span class="small-box-footer dash_field">{{trans('Partner Earning')}}</span>
              ...
              <div class="small-box dash_field">
                ...
                <div class="icon">
                  <i class="iconmoon icon-Bag"></i>
								...
								<span class="small-box-footer dash_field">{{trans('admin.earnings_net')}}</span>
              </div>
            </div><!-- ./col -->
    ...
    <div class="row">
      ...
      <section class="col-md-12">
        ...
        <div class="chart">
          ...
          <div class="box-footer dash_field">
            <div class="row">
              <div class="col-sm-4 col-xs-12">
                <div class="description-block border-right">
                  <h2 class="{{$stat_revenue_today > 0 ? 'text-white' : 'text-white' }}">{{ Helper::amountFormatDecimal($stat_revenue_today) }}</h2>
              ...
              <div class="col-sm-4 col-xs-12">
                <div class="description-block border-right">
                  <h2 class="{{$stat_revenue_week > 0 ? 'text-white' : 'text-white' }}">{{ Helper::amountFormatDecimal($stat_revenue_week) }}</h2>
              ...
              <div class="col-sm-4 col-xs-12">
                <div class="description-block">
                  <h2 class="{{$stat_revenue_month > 0 ? 'text-white' : 'text-white' }}">{{ Helper::amountFormatDecimal($stat_revenue_month) }}</h2>
			...
			<section class="col-md-7">
			    <div class="box dash_field">
    				 <div class="box-header with-border">
    					 <h3 class="box-title">{{ trans('admin.subscriptions_last_30_days') }}</h3>
			...
			<section class="col-md-5">
		  	<!-- Map box -->
              <div class="box dash_field box-solid bg-purple-gradient padding-zero">
