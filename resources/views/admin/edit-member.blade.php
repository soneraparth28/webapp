          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="plan" class="form-control">
                @if(isset($user->plans->first()->interval))
                <option value="no_plan">No Plan</option>
                <option @if ($user->plans->first()->interval == 'free') selected="selected" @endif value="free">Free</option>
                  <option @if($user->plans->first()->interval == 'monthly') selected="selected" @endif value="monthly">Monthly</option>
                  <option value="monthly_extend">Monthly Extend</option>
                   <option @if ($user->plans->first()->interval == 'yearly') selected="selected" @endif value="yearly">Yearly</option>
                @else
