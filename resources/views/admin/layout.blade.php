...
<html>
  <head>
    ...
    <link href="{{ asset('public/admin/css/custom-dark-mode.css')}}?v={{rand()}}" rel="stylesheet" type="text/css" />
    <!-- <link href="{{ asset('public/admin/css/custom-dark-mode.css')}}?v={{$settings->version}}" rel="stylesheet" type="text/css" /> -->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          @if (auth()->user()->hasPermission('invoices'))
            <!-- Links -->
            <li class="@if( Request::is('panel/admin/invoices') ) active @endif">
            	<a href="{{ url('panel/admin/invoices') }}"><i class="fa fa-file"></i> <span>{{ trans('admin.invoices') }}</span></a>
            </li><!-- ./Links -->
          @endif
