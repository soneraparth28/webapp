		...
		@endif
          ...
          <!-- Start Box Body -->
           ...
           <!-- Start Box Body -->
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                 ...
                 <p class="help-block"><a href="https://developer.revolut.com/docs/guides/accept-payments/get-started/generate-the-api-key" target="_blank">https://developer.revolut.com/docs/guides/accept-payments/get-started/generate-the-api-key</a></p>
                </div>
              </div>
            </div><!-- /.box-body -->
            ...
            <div class="box-body">
                 <div class="form-group">
                   <label class="col-sm-2 control-label">{{ trans('admin.sandbox') }}</label>
                   <div class="col-sm-10">
                     <div class="radio">
