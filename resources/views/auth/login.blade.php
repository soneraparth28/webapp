        ...
        <div class="row mnh-100vh mr-0">
            <div class="col-12 col-lg-6 xol-xl-5 mnh-100">
                <div class="flex-col-start flex-align-center vertical-middle p-4">
                    ...
                    <form method="POST" action="{{ url('login') }}" id="formLoginRegister" class="mt-3 mxw-100 mnw-75">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-theme mb-2">
                                ...
                                <input id="password" name="password" class="theme form-control" style="border-top-right-radius: 0px !important; border-bottom-right-radius: 0px !important" tabindex="2" value="" aria-required="true" type="password" placeholder="Enter password here" required="">
                    ...
                    <a href="{{url("creator-signup")}}" class="mt-4 color-dark font-16 text-center">{{trans("auth.not_have_account")}} <span class="font-weight-bold">{{trans("auth.signup")}}</span></a>
