...
<style>
    ...
    #max-size-image-container{
        background-image: url({{asset('public/img/password.png')}});
        ...
        <div class="row mnh-100vh mr-0">
            <div class="col-12 col-lg-6 xol-xl-5 mnh-100">
                <div class="flex-col-start flex-align-center vertical-middle p-4">
                    ...
                    <form method="POST" action="{{url('password/reset')}}" id="formLoginRegister" class="mt-3 mxw-100 mnw-75">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-theme mb-2">
                                ...
                                <input id="password" name="password" class="theme form-control"  tabindex="2" value="" aria-required="true" type="password" placeholder="{{trans('auth.password')}}" required="">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="font-16 font-weight-bold mb-0">{{trans('auth.confirm_password')}}</label>
                            <div class="input-group input-theme mb-2">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fa fa-lock"></i></span>
                                </div>
                                <input id="password" name="password_confirmation" class="theme form-control"  tabindex="2" value="" aria-required="true" type="password" placeholder="{{trans('auth.confirm_password')}}" required="">
                            </div>
                        </div>
                        ...
                        <button type="submit" class="dark-btn w-100 mt-2" id="btnLoginRegister" style="border-radius: 10px !important;"><i></i>{{trans('auth.reset_password')}}</button>
