    ...
    <div class="page-wrapper">
        ...
        <div class="row mnh-100vh mr-0">
            <div class="col-12 col-lg-6 xol-xl-5 mnh-100">
                <div class="flex-col-start flex-align-center vertical-middle p-4">
                    <div class="flex-col-start flex-align-center w-60">
                        ...
                        <p class="font-25 font-weight-bold mt-2 mb-0">Create An Account</p>
                        <p class="font-20">Let’s get started</p>
                    </div>

                    <form method="POST" action="{{ route('register') }}" id="formLoginRegister" class="mt-3 mxw-100 mnw-75">
                        @csrf
            ...
            <div class="d-none d-lg-flex col-lg-6 xol-xl-7 p-0 mnh-100 position-relative">
                <div id="max-size-image-container-signup">
                    <!--<img src="{{asset('public/img/advert/pexels.jpg')}}" class="noSelect" />-->
