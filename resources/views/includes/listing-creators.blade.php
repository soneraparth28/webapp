	...
	<div class="card-body text-center">
			...
			<a style="border:1px solid black;padding-top:11px;border-radius:11px;height:47px;" href="{{url($response->username)}}" class="btn btn-1 btn-sm ctaLogin">{{trans('general.go_to_page')}}</a>

			<a href="{{url($response->username)}}" class="dark-btn mnw-50 active">
