...
<div class="msg-inbox m-0 rounded-0">
	<div class="list-group list-group-sm list-group-flush rounded-0">

		<a href="{{url('messages/'.$userID, $username)}}" class="item-chat @if(request()->is("messages/$userID/$username")) bg-lightest-gray @else hover-bg-lighest-gray @endif text-decoration-none p-4{{$styleStatus}}  @if (request()->id == $userID) active disabled @endif">
			<div class="media">
