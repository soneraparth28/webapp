					...
					<div class="card-body px-lg-5 py-lg-5">
						...
						<div class="mb-2">
							...
							@if (auth()->user()->verified_id == 'yes' && request()->is('messages') && auth()->user()->totalSubscriptionsActive() > 1)
                                <button  data-toggle="modal" data-target="#newMessageMassive" data-dismiss="modal" class="dark-btn w-100 mt-2">
				...
				<div class="card-footer bg-white border-0 pt-0 position-relative">
					...
					<div class="justify-content-between align-items-center">
						...
						<div class="d-inline-block float-right mt-3 rounded-pill position-relative">
							...
							<button disabled type="submit" id="button-reply-msg" class="dark-btn mnw-50px pt-1 pb-1 pl-2 pr-2 rounded-pill float-right e-none"><i class="far fa-paper-plane"></i></button>
						</div>
