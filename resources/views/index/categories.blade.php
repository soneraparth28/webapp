...
<div class="navbar-collapse collapse d-lg-block" id="navbarFilters">
  <div class="btn-block mb-3">
    <span>
      ...
      <i class="bi bi-filter-right mr-2"></i>
          {{trans('general.filter_by')}}
      </span>

  <a class="text-muted btn btn-sm bg-theme-card border mb-2 e-none btn-category @if(request()->is('category/'.$slug.''))active-category @endif" href="{{url('category', $slug)}}">
...
{{--      <img src="{{url('public/img/popular.png')}}" class="mr-2" width="30" /> {{trans('general.popular')}}--}}
  ...
  <a class="text-muted btn btn-sm bg-theme-card border mb-2 e-none btn-category @if(request()->is('category/'.$slug.'/featured'))active-category @endif" href="{{url('category/'.$slug.'','featured')}}">
...
{{--    <img src="{{url('public/img/featured.png')}}" class="mr-2" width="30" /> {{trans('general.featured_creators')}}--}}
  ...
  <a class="text-muted btn btn-sm bg-theme-card border mb-2 e-none btn-category @if(request()->is('category/'.$slug.'/more-active'))active-category @endif" href="{{url('category/'.$slug.'','more-active')}}">
  ...
  <a class="text-muted btn btn-sm bg-theme-card border mb-2 e-none btn-category @if(request()->is('category/'.$slug.'/new'))active-category @endif" href="{{url('category/'.$slug.'','new')}}">
  ...
  <a class="text-muted btn btn-sm bg-theme-card border mb-2 e-none btn-category @if(request()->is('category/'.$slug.'/free'))active-category @endif" href="{{url('category/'.$slug.'','free')}}">
