                    ...
                    <div class="row">
                        <div class="col-12 mt-3 mt-lg-0">
                            <div class="flex-row-start flex-align-center">
                                <p class="font-22 font-weight-bold mb-0">Edit Channel</p>
                            </div>
                            <div class="row mt-4">
                                <div class="col-lg-12">
                                    @include('errors.errors-forms')
                                    <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{url('my/channel/'.$channel->id.'/update')}}">
                                        @csrf
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">{{trans('general.channel_name')}} *</label>
                                            <input type="text" id="channel" name="channel" value="{{ $channel->channel }}" placeholder="Channel Name" class="form-control" autocomplete="off" style="color: #000!important;">
                                        </div>
