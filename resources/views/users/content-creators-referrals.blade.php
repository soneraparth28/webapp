                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-3 mt-lg-0">
                                ...
                                <div class="flex-row-start flex-align-center">
                                    ...
                                    <p class="font-22 font-weight-bold mb-0 ml-3">Creator referrals</p>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="mt-1 col-12 col-lg-6">
                                                <div class="flex-col-start">
                                                    <p class="color-gray font-16 mb-0">Share your link and earn 40% of your referrals, be it a subscription, Tip or a PPV!</p>
                                                    <p class="color-gray font-14 mb-0">* You will earn 40% for each transaction of your referral.</p>
                                                </div>
                                            </div>
                                            <div class="mt-1 col-12 col-lg-6">
                                                <div class="flex-row align-items-center justfiy-content-start justify-content-lg-end">
                                                    <div class="flex-col-start">
                                                        ...
                                                        <p class="color-gray font-14 mb-0 font-weight-bold">{{ url('/creator-signup?cc-ref='.auth()->user()->id) }}</p>
                                                    </div>

                                                    <button class="d-none copy-url" id="copyLink" data-clipboard-text="{{ url('/creator-signup?cc-ref='.auth()->user()->id) }}"></button>
                                            ...
                                            <div class="card-body">
                                                <div class="flex-col-start">
                                                    <div class="flex-row-start flex-align-center">
                                                        ...
                                                        <p class="font-16 mb-0 ml-2">Total registered</p>
                                                    </div>
                                                    <o class="font-22 font-weight-bold mb-0">{{ number_format(auth()->user()->ccRefers(auth()->user()->id)->count()) }}</o>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card border-radius-5px">
                                            <div class="card-body">
                                                <div class="flex-col-start">
                                                    ...
                                                    <o class="font-22 font-weight-bold mb-0">{{ number_format(auth()->user()->ccReferralTransactions()->count()) }}</o>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card border-radius-5px">
                                            <div class="card-body">
                                                <div class="flex-col-start">
                                                    ...
                                                    <o class="font-22 font-weight-bold mb-0">{{ Helper::amountFormatDecimal(auth()->user()->ccReferralTransactions()->sum('earnings')) }}</o>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
