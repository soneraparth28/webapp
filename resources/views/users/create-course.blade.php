                    ...
                    <div class="col-12 col-xl-9 mt-2 pb-5">
                        ...
                        <div class="row mt-3 align-items-center">
                            ...
                            <div class="col-12 col-md-6 mt-2 desktopOnlyFlex">
                                <form id="publish_course" action="{{url("create/course")}}" method="post" class="w-100" enctype="multipart/form-data">
                                    @csrf
...
{{--                            Module--}}
                            <div class="flex-col-start content-parent dataParentContainer" data-content-type="module" data-content-id="1">
                                ...
                                <input class="form-control mt-1 mimic-text-input mb-3" style="border-radius: 10px !important;" value="Module 1" autocomplete="off" name="module_title"
